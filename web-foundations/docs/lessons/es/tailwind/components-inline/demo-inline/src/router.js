/**
 * router.js — Simple router that loads view templates from files
 * Inline demo uses only view templates (no components or helpers)
 */

export class SimpleRouter {
	constructor(routes) {
		this.routes = routes; // { '/': { templateId, templateUrl }, ... }
